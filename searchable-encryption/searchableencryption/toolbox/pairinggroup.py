try:
    ...
    from charm.core.math.pairing import pairing, ZR, G1, G2, GT, init, pair, hashPair,\
        H, random, ismember, order
    from charm.core.math.pairing import serialize as charm_serialize
    from charm.core.math.pairing import deserialize as charm_deserialize
...
class PairingGroup(object):
    """ Replace the same class in Charm toolbox because we cannot initialize a pairing group from a string. Unbelievable
    """
    ...
    def deserialize(self, obj):
        ...
        """
        return charm_deserialize(self.Pairing, obj)
